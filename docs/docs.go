    ...
    "paths": {
        ...
        "/qris/generate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Branch ID and transaction amount",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/qris.GenerateQRISInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Dynamic QRIS string and image",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Missing amount or no active QRIS",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/qris/upload": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "QRIS image file (PNG or JPG, max 2MB)",
                        "name": "image",
                        "in": "formData",
                        "required": true
                    },
                ...
                "responses": {
                    "201": {
                        "description": "QRIS uploaded and stored successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Invalid image, invalid QRIS string, or CRC mismatch",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/shifts/branch": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of branch shifts",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/shifts/close": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Shift closed with report",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/shifts/open": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Already have an open shift",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
